...
class AuthorListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_located(self):
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user2 = User.objects.create_user(username='testuser1', password='12345')
        test_user1.save()
        ...
        def test_login_inwith_permission_borrowed_book(self):
        ...
        def test_form_renewal_date_initialy_has_date_three_weeks_in_future(self):
            login = self.client.login(username='testuser2', password='12345')
            resp = self.client.get(reverse('renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk,}))
            self.assertEqual( resp.status_code, 200)
